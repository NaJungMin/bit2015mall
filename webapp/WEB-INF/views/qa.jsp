...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="747">
				...
				<tr>
					<td height="30"><img src="/assets/images/qa_title.gif" width="746" height="30" border="0"></td>
				</tr>
				<tr><td height="13"></td></tr>
			</table>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="690">
				<tr>
					<td><img src="/assets/images/qa_title1.gif" border="0"></td>
				</tr>
				<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="690" class="cmfont">
				...
				<tr height="25" bgcolor="#FFFFFF">	
					...
					<td><img src="/assets/images/i_re.gif" border="0" align="absmiddle">&nbsp;<a href="qa_read.jsp?no=2&page=1&sel1=1&text1="><font color="#4186C7">Re:새소식1</font></a></td>	
				...
				<tr height="25" bgcolor="#FFFFFF">	
					...
					<td>&nbsp;&nbsp;&nbsp;
						<img src="/assets/images/i_re.gif" border="0" align="absmiddle">&nbsp;<a href="qa_read.jsp?no=3&page=1&sel1=1&text1="><font color="#4186C7">Re:새소식1</font></a>
					</td>	
					<td width="90" align="center"><font color="#686868">관리자</font></td>	
					<td width="90" align="center"><font color="#686868">2007-01-02</font></td>	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="690">
				...
				<tr>
					<td height="40">&nbsp;
						...
						<input type="image" src="/assets/images/i_search.gif" align="absmiddle" border="0" onclick="javascript:Search_qa();">
					</td>
					<td align="right">
						<a href="qa_new.jsp"><img src="/assets/images/b_new.gif" border="0"></a>&nbsp;
					</td>
				</tr>
				</form>
				<!-- form2 끝 -->
