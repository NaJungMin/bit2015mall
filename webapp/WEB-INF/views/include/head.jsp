...
<table width="959" border="0" cellspacing="0" cellpadding="0" align="center">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="182">
				<tr>
					<td>
						...
						<img src="/assets/images/top_logo.gif" width="182" height="40" border="0">
						</a>
					</td>
				</tr>
			</table>
	...
	<c:choose>		
		<c:when test="${empty authUser }">
			...
			<td><a href="/user/member_login"><img src="/assets/images/top_menu02.gif" border="0"></a></td>
			<td><img src="/assets/images/top_menu_line.gif" width="11"></td>
		...
		<c:otherwise>
			...
			<td><img src="/assets/images/top_menu_line.gif" width="11"></td>
			<!-- 로그아웃 -->
			<td><a href="/user/member_logout"><img src="/assets/images/top_menu02_1.gif" border="0"></a></td>
			<td><img src="/assets/images/top_menu_line.gif" width="11"></td>
			<!-- 회원정보수정 -->
