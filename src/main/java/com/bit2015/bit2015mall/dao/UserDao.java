...
public class UserDao {
	...
	//insert
		...
		public UserVo get( String id, String password ) {
			...
			UserVo vo = (UserVo)sqlMapClientTemplate.queryForObject( "user.getByIdAndPassword", map );
			return vo;
		}
		
		public UserVo member_modify_view(long no){
			System.out.println("UserDao : " + no);
			UserVo vo = (UserVo) sqlMapClientTemplate.queryForObject("user.member_modify_view", no);
			return vo;
		}
